...
enum Operation {
    ...
    DIVIDE {
        public double action(double arg0, double arg1) throws ZeroDivisionException {
            if (arg1 != 0.0) return arg0 / arg1;

            throw new ZeroDivisionException("You can't divide by zero");
        }
    };

    public abstract double action(double arg0, double arg1) throws ZeroDivisionException;
}
